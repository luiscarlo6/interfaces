 ...
 */
public class Reto1 extends Activity implements View.OnTouchListener, View.OnClickListener {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.botonGaleria:
                Intent Vista= new Intent("com.example.luiscarlo.fotolingo.Principal");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        Intent Vista = new Intent("com.example.luiscarlo.fotolingo.SubirReto1");
        startActivity(Vista);
    }
}
