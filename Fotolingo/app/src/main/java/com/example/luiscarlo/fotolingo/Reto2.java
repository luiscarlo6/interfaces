 ...
 */
public class Reto2 extends Activity implements View.OnTouchListener, View.OnClickListener {

    String arregloConsejo[]= {"Sincroniza tu vista y el disparo de cámara ","Dispón de luz adecuada para fotos de alta velocidad",
            "Consigue punto interesante usando la transparencia del agua"};
    int cont=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.reto_2);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.botonGaleria:
                Intent Vista = new Intent("com.example.luiscarlo.fotolingo.PrincipalReto2");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        Intent Vista = new Intent("com.example.luiscarlo.fotolingo.SubirReto2");
        startActivity(Vista);
    }
}
